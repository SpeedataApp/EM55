package com.spdata.em55.px.finger;
...
//        Bugtags.onResume(this);
        try {
            DevCtrl = new DeviceControl(DeviceControl.PowerType.MAIN_AND_EXPAND,63,5);
...
//    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        btnOffDevice = (Button) findViewById(R.id.btn_offdevice);
        btnOnDevice = (Button) findViewById(R.id.btn_ondevice);
        Log.d("Reginer", "onCreate: 888888888888888");
        btnOnDevice.setOnClickListener(new OnClickListener() {
            @Override
        ...
        btnOffDevice.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
                try {
                    DevCtrl.PowerOffDevice();
        ...
        Log.d("Reginer", "onCreate: 9999999999999999999999");
    }
